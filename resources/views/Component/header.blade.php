<div id="header">
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="/trangchu/main" id="logo"><img src="{{ asset('source/assets/dest/images/logo-cake.png')}}" width="200px" alt=""></a>
				</div>
			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						<li><a href="/trangchu/main">Trang chủ</a></li>
						<li><a href="#">Sản phẩm</a>
							<ul class="sub-menu">
                                @foreach($loai_sp as $type)
                                    <li><a href="/trangchu/type_product/{{$type->id}}">{{ $type->name}}</a></li>
                                @endforeach
							</ul>
						</li>
