  ...
  <table id="table_admin_product" class="table table-striped display">
    <thead>
      <tr>
        ...
        <th scope="col">New</th>
        <th scope="col"><a href="/addProduct" class="btn btn-primary" style="width:80px;">Add</a></th>
      </tr>
    </thead>
    <tbody>
      ...
      <tr class="products-list-admin">
        ...
        <td>{{$product->new}}</td>
        <td>
          <a href='/editProduct/{{$product->id}}' type="submit" class="btn btn-warning" style="width:80px;">Edit</a>
          <form role="form" action="/deleteProduct/{{$product->id}}" method="post">
            @csrf
